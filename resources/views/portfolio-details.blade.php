...
@section('title', 'Project Showcase | Srikaram Constructions')

@section('content')
    <x-pageHeader title="Luxury Residential Villa" subtitle="Project Details" />
            ...
            <div class="row g-5">
                <div class="col-lg-8 sr-reveal">
                    <div class="sr-card overflow-hidden mb-5">
                        <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Featured Project" class="w-100" style="height: 500px; object-fit: cover;">
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-6">
                            <img src="{{ asset('assets/images/service-interior.png') }}?v=1.0.1" alt="Interior Work" class="w-100 rounded-4" style="height: 250px; object-fit: cover;">
                        </div>
                        <div class="col-6">
                            <img src="{{ asset('assets/images/service-survey.png') }}?v=1.0.1" alt="Survey Work" class="w-100 rounded-4" style="height: 250px; object-fit: cover;">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="sr-sticky-sidebar">
                        ...
                        <div class="sr-card p-5 border-primary text-center" style="border: 2px solid var(--sr-primary);">
                            ...
                            <a href="{{ route('contact') }}" class="sr-btn w-100">Get a Free Estimate</a>
                        </div>
                    </div>
                </div>
            </div>
