...
@section('title', 'Our Portfolio | Srikaram Constructions')

@section('content')
    <x-pageHeader title="Our Landmark Projects" subtitle="Portfolio" />
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 sr-reveal">
                    <div class="sr-portfolio-card">
                        <div class="sr-portfolio-card__img">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Luxury Villa Construction">
                            <div class="sr-portfolio-card__overlay">
                                <div class="content">
                                    <span class="category">Residential</span>
                                    <h3>Luxury Private Villa</h3>
                                    <p>Hyderabad, Telangana</p>
                                    <a href="{{ route('portfolio-details') }}" class="sr-btn sr-btn--sm mt-3">View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 sr-reveal" data-wow-delay="0.2s">
                    <div class="sr-portfolio-card">
                        <div class="sr-portfolio-card__img">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Corporate Interior Design">
                            <div class="sr-portfolio-card__overlay">
                                <div class="content">
                ...
                <div class="col-lg-4 col-md-6 sr-reveal" data-wow-delay="0.4s">
                    <div class="sr-portfolio-card">
                        <div class="sr-portfolio-card__img">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Digital Land Survey">
                            <div class="sr-portfolio-card__overlay">
                                <div class="content">
                ...
                <div class="col-lg-4 col-md-6 sr-reveal">
                    <div class="sr-portfolio-card">
                        <div class="sr-portfolio-card__img">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Apartment Complex">
                            <div class="sr-portfolio-card__overlay">
                                <div class="content">
                ...
                <div class="col-lg-4 col-md-6 sr-reveal" data-wow-delay="0.2s">
                    <div class="sr-portfolio-card">
                        <div class="sr-portfolio-card__img">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Residential Interior">
                            <div class="sr-portfolio-card__overlay">
                                <div class="content">
                                    <span class="category">Interiors</span>
                ...
                <div class="col-lg-4 col-md-6 sr-reveal" data-wow-delay="0.4s">
                    <div class="sr-portfolio-card">
                        <div class="sr-portfolio-card__img">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Topographical Survey">
                            <div class="sr-portfolio-card__overlay">
                                <div class="content">
    ...
    <section class="sr-section" style="background: var(--sr-primary);">
        <div class="container text-center">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-center gap-3">
                <a href="{{ route('contact') }}" class="sr-btn sr-btn--dark">Get a Free Estimate</a>
