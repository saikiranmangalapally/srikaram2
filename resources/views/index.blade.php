...
@section('title', 'Srikaram Constructions | House Construction, Interiors & Land Survey')
    ...
    <style>
        .sr-hero {
            ...
            background: 
                ...
                url('{{ asset('assets/images/hero-construction.png') }}?v=1.0.1') center/cover no-repeat;
            color: #fff;
        }
    </style>
@endpush
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 sr-reveal">
                        <article class="sr-card">
                            ...
                            <a class="sr-link" href="{{ route('construction') }}">Explore Service <i class="fas fa-chevron-right"></i></a>
                        </article>
                    </div>
                    <div class="col-lg-4 col-md-6 sr-reveal">
                        <article class="sr-card">
                            ...
                            <a class="sr-link" href="{{ route('interior-design') }}">Explore Service <i class="fas fa-chevron-right"></i></a>
                        </article>
                    </div>
                    <div class="col-lg-4 col-md-6 sr-reveal">
                        <article class="sr-card">
                            ...
                            <a class="sr-link" href="{{ route('land-surveying') }}">Explore Service <i class="fas fa-chevron-right"></i></a>
                        </article>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center g-5">
                    <div class="col-lg-6 sr-reveal">
                        <div class="sr-about-visual">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Srikaram Construction">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 sr-reveal">
                        <div class="sr-portfolio-card">
                            <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Construction Project">
                    ...
                    <div class="col-lg-4 col-md-6 sr-reveal">
                        <div class="sr-portfolio-card">
                            <img src="{{ asset('assets/images/service-interior.png') }}?v=1.0.1" alt="Interior Project">
                            <div class="sr-portfolio-info">
                    ...
                    <div class="col-lg-4 col-md-6 sr-reveal">
                        <div class="sr-portfolio-card">
                            <img src="{{ asset('assets/images/service-survey.png') }}?v=1.0.1" alt="Survey Project">
                            <div class="sr-portfolio-info">
