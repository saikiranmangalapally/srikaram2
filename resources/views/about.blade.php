...
@section('title', 'About Us | Srikaram Constructions')

@section('content')
    <x-pageHeader title="About Our Legacy" subtitle="About Us" />
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 sr-reveal">
                    <div class="sr-about-visual">
                        <img src="{{ asset('assets/images/hero-construction.png') }}?v=1.0.1" alt="Building Excellence" class="img-fluid rounded-4 shadow-lg">
    ...
    <section class="sr-section sr-section--tight" style="background: var(--sr-primary);">
        <div class="container">
            <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between gap-4 text-center text-lg-start sr-reveal">
                ...
                <a href="{{ route('index') }}#contact" class="sr-btn" style="background: #fff; color: var(--sr-primary);">
