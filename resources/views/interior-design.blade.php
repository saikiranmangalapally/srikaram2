...
@section('title', 'Modern Interior Design | Srikaram Constructions')

@section('content')
    <x-pageHeader title="Elegance In Every Corner" subtitle="Interior Design" />
            ...
            <div class="row g-5">
                <div class="col-lg-8 sr-reveal">
                    <div class="sr-card overflow-hidden mb-5">
                        <img src="{{ asset('assets/images/service-interior.png') }}?v=1.0.1" alt="Interior Excellence" class="w-100" style="height: 450px; object-fit: cover;">
                    </div>
