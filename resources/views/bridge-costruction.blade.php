...
@section('content')
    ...
    <x-pageHeader title="Bridge Costruction" subtitle="Bridge Costruction" />
                    ...
                    <div class="services-details__sidebar">
                        ...
                        <div class="services-details__single sidebar__category">
                            ...
                            <ul class="sidebar__category-list">
                                <li class="active"><a href="#">Bridge Costruction <span class="icon-caret"></span></a></li>
                                <li><a href="{{ route('petroleum-refinery') }}">Petroleum Refinery
