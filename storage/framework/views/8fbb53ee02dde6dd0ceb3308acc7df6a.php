<?php $__env->startSection('title', 'Our Services | Srikaram Constructions'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Expert Building Solutions','subtitle' => 'Our Services']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Expert Building Solutions','subtitle' => 'Our Services']); ?>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 sr-reveal">
                    <div class="sr-service-card-large">
                        <div class="sr-service-card-large__img">
                            <a href="<?php echo e(route('construction')); ?>"><img src="<?php echo e(asset('assets/images/hero-construction.png')); ?>?v=1.0.1" alt="Construction"></a>
                        </div>
                        <div class="sr-service-card-large__content">
                            ...
                            <a href="<?php echo e(route('construction')); ?>" class="sr-btn sr-btn--outline w-100 mt-4">View Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 sr-reveal" data-wow-delay="0.2s">
                    <div class="sr-service-card-large">
                        <div class="sr-service-card-large__img">
                            <a href="<?php echo e(route('interior-design')); ?>"><img src="<?php echo e(asset('assets/images/service-interior.png')); ?>?v=1.0.1" alt="Interior Design"></a>
                        </div>
                        <div class="sr-service-card-large__content">
                            ...
                            <a href="<?php echo e(route('interior-design')); ?>" class="sr-btn sr-btn--outline w-100 mt-4">View Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 sr-reveal" data-wow-delay="0.4s">
                    <div class="sr-service-card-large">
                        <div class="sr-service-card-large__img">
                            <a href="<?php echo e(route('land-surveying')); ?>"><img src="<?php echo e(asset('assets/images/service-survey.png')); ?>?v=1.0.1" alt="Land Surveying"></a>
                        </div>
                        <div class="sr-service-card-large__content">
                            ...
                            <a href="<?php echo e(route('land-surveying')); ?>" class="sr-btn sr-btn--outline w-100 mt-4">View Details</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\saikiranmangalapally\Downloads\srikaram_flat_files\resources\views/services.blade.php ENDPATH**/ ?>