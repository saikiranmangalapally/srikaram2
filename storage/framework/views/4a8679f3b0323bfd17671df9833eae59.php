    ...
    <div class="container">
            ...
            <div class="col-xl-2 col-lg-6">
                <div class="sr-footer-widget">
                    ...
                    <ul class="sr-footer-list">
                        ...
                        <li><a href="<?php echo e(route('portfolio')); ?>">Our Projects</a></li>
                        <li><a href="<?php echo e(route('team')); ?>">Expert Team</a></li>
        ...
        <div class="sr-footer-bottom mt-5 pt-4 border-top" style="border-color: rgba(255,255,255,0.1) !important;">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0" style="color: rgba(255,255,255,0.5); font-size: 14px;">&copy; <?php echo e(date('Y')); ?> Srikaram Constructions. All rights reserved.</p>
                </div>
...
<?php /**PATH C:\Users\saikiranmangalapally\Downloads\srikaram_flat_files\resources\views/components/footer_style_one.blade.php ENDPATH**/ ?>