...
<section class="sr-page-header">
    <div class="sr-page-header__bg" style="background-image: url('<?php echo e(asset('assets/images/page-header-bg-premium.png')); ?>?v=1.0.2');"></div>
    <div class="sr-page-header__overlay"></div>
    <div class="container">
        <div class="sr-page-header__content sr-reveal">
            <h1 class="sr-page-header__title"><?php echo e($title ?? 'Srikaram'); ?></h1>
            <ul class="sr-breadcrumb">
                <li><a href="<?php echo e(route('index')); ?>">Home</a></li>
                <li class="separator"><i class="fas fa-chevron-right"></i></li>
                <li class="current"><?php echo e($subtitle ?? 'Details'); ?></li>
            </ul>
        </div>
    </div>
</section>
...
<?php /**PATH C:\Users\saikiranmangalapally\Downloads\srikaram_flat_files\resources\views/components/pageHeader.blade.php ENDPATH**/ ?>