<?php $__env->startSection('title', 'Residential & Commercial Construction | Srikaram Constructions'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Building Excellence','subtitle' => 'Construction Services']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Building Excellence','subtitle' => 'Construction Services']); ?>
            ...
            <div class="row g-5">
                <div class="col-lg-8 sr-reveal">
                    <div class="sr-card overflow-hidden mb-5">
                        <img src="<?php echo e(asset('assets/images/hero-construction.png')); ?>?v=1.0.1" alt="Construction Excellence" class="w-100" style="height: 450px; object-fit: cover;">
                    </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\saikiranmangalapally\Downloads\srikaram_flat_files\resources\views/construction.blade.php ENDPATH**/ ?>